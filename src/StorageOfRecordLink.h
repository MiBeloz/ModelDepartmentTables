...
//     StorageOfRecordLink(StorageOfRecordLink&& other) noexcept {
//         QWriteLocker otherLocker(&other.m_lock);

//         m_storageOfRecordLink = std::move(other.m_storageOfRecordLink);
//         m_storageOfRecordLinkTmp = std::move(other.m_storageOfRecordLinkTmp);
//         m_commit = other.m_commit;
//         other.m_commit = true;
//     }
...
//         return *this;
//     }
//     StorageOfRecordLink& operator =(StorageOfRecordLink&& other) noexcept {
//         if (this == &other) {
//             return *this;
//         }
