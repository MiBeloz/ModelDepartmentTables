...
private slots:
    ...
    void testInsert() {
        QCOMPARE(ld.insert("25.08.2025"), 1);
        QCOMPARE(ld.size(), 1);

        QCOMPARE(ld.insert("15.07.2024"), 2);
        QCOMPARE(ld.insert("18.03.2020"), 3);
        QCOMPARE(ld.insert("05.11.2021"), 4);
        QCOMPARE(ld.size(), 4);

        QCOMPARE(ld.insert("18.03.2020"), 3);
        QCOMPARE(ld.size(), 4);

        QCOMPARE(ld.insert("28.08.2019"), 5);
        QCOMPARE(ld.size(), 5);

        QCOMPARE(ld.insert("55.08.2019"), -1);
    }
