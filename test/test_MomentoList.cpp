...
class TestMomentoList final : public QObject {
    Q_OBJECT
    Q_DISABLE_COPY_MOVE(TestMomentoList)

public:
    TestMomentoList() = default;
...
QTEST_APPLESS_MAIN(TestMomentoList)
#include "test_MomentoList.moc"
